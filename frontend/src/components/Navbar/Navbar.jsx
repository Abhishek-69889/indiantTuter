...
export default function Navbar() {
  ...
  return (
    <>
      <div className="fixed  w-full   left-0 top-0  " id='navbar-main' >
        <div className="mx-auto flex max-w-7xl   items-center justify-around px-4 py-2 sm:px-6 lg:px-8">
          ...
          <span className="navbar-logo">
            ...
            <Link className="font-bold text-black cursor-pointer" to='/'>Indian Tutor Expert</Link>
          </div>
            ...
            <ul className="ml-12 inline-flex space-x-10" >
              {menuItems.map((item) => (
                <li key={item.name}>
                  <Link
                    to={item.to}
                    className="inline-flex items-center text-sm font-semibold text-[35px] text-black hover:text-gray-800"
                    id='nav-main-div'
                  >
                    {item.name}
          ...
          <div id='nav-icon-search'>
            ...
            {/* <Link  id='nav-main-search-Link'
        type='button'
        to='/search'
       >
          
          <h1>Search Language</h1>
          <h2 className='rounded'>ctrl k</h2>
        </Link> */}
                ...
                <div className="px-5 pb-6 pt-5">
                  <div className="flex items-center justify-between">
                    <div className="inline-flex items-center space-x-2">
                      ...
                      <span className="font-bold">Indian Tutor Expert</span>
                    </div>
                    <div className="-mr-2">
                      <button
                        type="button"
